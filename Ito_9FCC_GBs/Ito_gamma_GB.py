...
import os
from Ito_ASE_setup import get_pure_bulk, define_calc, set_optimizer, get_GB_novac_relaxed, get_bulk_number_of_atom
...
def gamma_GB_cal(E_bulk, bulk_number_of_atom, potchoice, GBchoice, fmax, optimizer, steps):
    GB = get_GB_novac_relaxed(potchoice, GBchoice)
...
def run_cal (pot_list, GB_list, fmax, optimizer, steps):
    ...
    for potchoice in pot_list:
        ...
        for GBchoice in GB_list:
            gamma_GB = gamma_GB_cal(E_bulk, bulk_number_of_atom, potchoice, GBchoice, fmax, optimizer, steps)
